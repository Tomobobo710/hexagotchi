...
void TherapistOfficeScene::init() {
    ...
    scenarios.push_back({
        ...
        { CharacterId::Judy, "So Tom, how have you been\nprocessing the divorce?",
          1, false, false, PortraitEmotion::Mid, "Judy (Tom's therapist)",
        ...
        // Tom gives up correcting her and just talks about the real thing.
        ...
        // The near-realization -- and the cutoff.
